...
export default function LeadCard({ lead }) {
  ...
  return (
    <Card className="group hover:shadow-2xl transition-all duration-300" style={{
      background: 'linear-gradient(135deg, #0a1929 0%, #1a2332 100%)',
      border: '1.5px solid #5e6a78',
    }}
    ...
    >
      <CardContent className="p-5">
          ...
          <div className="flex flex-col items-end gap-1 flex-shrink-0">
            ...
            {lead.category && (
              <span className="text-xs px-2 py-0.5 rounded-full" style={{
                background: 'rgba(248,212,23,0.15)',
                color: '#f8d417',
                border: '1px solid rgba(248,212,23,0.3)'
              }}>
                {lead.category}
              </span>
            )}
        ...
        {/* Bio */}
        {lead.bio && (
          <p className="text-xs mb-3 line-clamp-2" style={{ color: '#9ea7b5' }}>
            {lead.bio}
          </p>
        )}
            ...
            <div className="flex items-center gap-2 text-xs" style={{ color: '#d7dde5' }}>
              ...
              {areaCode && (
                <span className="text-xs px-1.5 py-0.5 rounded" style={{
                  background: 'rgba(84,176,231,0.15)',
                  color: '#54b0e7',
                  border: '1px solid rgba(84,176,231,0.3)'
                }}>
        ...
        {lead.tag && (
          <div className="mt-2 flex items-center gap-1.5">
            ...
            <span className="text-xs px-2 py-0.5 rounded-full" style={{
              background: 'rgba(246,108,37,0.15)',
              color: '#f66c25',
              border: '1px solid rgba(246,108,37,0.3)'
            }}>
              {lead.tag}
            </span>
          </div>
